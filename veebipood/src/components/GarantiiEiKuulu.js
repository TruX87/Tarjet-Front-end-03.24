...
function GarantiiEiKuulu() {
  return (
    <div><h4>4. GARANTII ALLA EI KUULU:</h4>
    ...
    <br />
    4.7. Tooted, mille välimust on muudetud, mida on avatud/parandatud mitte tootja autoriseeritud hoolduses või millel on eemaldatud/katki tehtud garantii turvakleebis.</div>
  )
}

export default GarantiiEiKuulu