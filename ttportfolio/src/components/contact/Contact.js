...
const Contact = () => {
  ...
  const handleSend = (e) => {
    ...
    if (clientName && email && EmailValidation(email) && messages) {
      axios.post("https://getform.io/f/rbeqvvwb", {
        name: clientName,
        email: email,
        message: messages,
      });
  ...
  return (
    <div className="w-full">
      <Title title="Võta" subTitle="ühendust" />
      ...
      <div className="w-full mt-10">
        <Title title="Saada" subTitle="kiri" />
        {seuccessMsg ? (
          ...
          <form
            id="form"
            action="https://getform.io/f/rbeqvvwb"
            method="POST"
